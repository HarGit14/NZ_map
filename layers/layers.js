...
var format_50kmPunkterck_9 = new ol.format.GeoJSON();
var features_50kmPunkterck_9 = format_50kmPunkterck_9.readFeatures(json_50kmPunkterck_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_50kmPunkterck_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_50kmPunkterck_9.addFeatures(features_50kmPunkterck_9);
var lyr_50kmPunkterck_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_50kmPunkterck_9, 
                style: style_50kmPunkterck_9,
                popuplayertitle: '50 km Punkte rück',
                interactive: true,
                title: '<img src="styles/legend/50kmPunkterck_9.png" /> 50 km Punkte rück'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_tourism_attraction_full_1.setVisible(true);lyr_AusFacebook_2.setVisible(true);lyr_Attr_manual_3.setVisible(true);lyr_Viewpoints_4.setVisible(true);lyr_tourism_viewpoint_5.setVisible(true);lyr_Verena_Tspots_6.setVisible(true);lyr_South_Route_27200_7.setVisible(true);lyr_Northland_Route_27200_8.setVisible(true);lyr_50kmPunkterck_9.setVisible(true);lyr_50kmPunktehin_10.setVisible(true);lyr_50kmPunkte_South_11.setVisible(true);lyr_Favorites_12.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_tourism_attraction_full_1,lyr_AusFacebook_2,lyr_Attr_manual_3,lyr_Viewpoints_4,lyr_tourism_viewpoint_5,lyr_Verena_Tspots_6,lyr_South_Route_27200_7,lyr_Northland_Route_27200_8,lyr_50kmPunkterck_9,lyr_50kmPunktehin_10,lyr_50kmPunkte_South_11,lyr_Favorites_12];
...
lyr_50kmPunkterck_9.set('fieldAliases', {'fid': 'fid', 'name': 'name', 'distance': 'distance', 'angle': 'angle', });
...
lyr_50kmPunkterck_9.set('fieldImages', {'fid': 'TextEdit', 'name': 'TextEdit', 'distance': 'TextEdit', 'angle': 'TextEdit', });
...
lyr_AusFacebook_2.set('fieldLabels', {'address': 'no label', 'country': 'no label', 'descriptio': 'no label', 'result_num': 'no label', 'osm_id': 'no label', 'display_na': 'no label', 'category': 'no label', 'type': 'no label', 'latlong': 'no label', });
...
lyr_50kmPunkterck_9.set('fieldLabels', {'fid': 'no label', 'name': 'no label', 'distance': 'no label', 'angle': 'no label', });
