...
var format_tourism_attraction_full_1 = new ol.format.GeoJSON();
var features_tourism_attraction_full_1 = format_tourism_attraction_full_1.readFeatures(json_tourism_attraction_full_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_tourism_attraction_full_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_tourism_attraction_full_1.addFeatures(features_tourism_attraction_full_1);
var lyr_tourism_attraction_full_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_tourism_attraction_full_1, 
                style: style_tourism_attraction_full_1,
                popuplayertitle: 'tourism_attraction_full',
                interactive: true,
                title: '<img src="styles/legend/tourism_attraction_full_1.png" /> tourism_attraction_full'
            });
var format_AusFacebook_2 = new ol.format.GeoJSON();
var features_AusFacebook_2 = format_AusFacebook_2.readFeatures(json_AusFacebook_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AusFacebook_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AusFacebook_2.addFeatures(features_AusFacebook_2);
var lyr_AusFacebook_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AusFacebook_2, 
                style: style_AusFacebook_2,
                popuplayertitle: 'AusFacebook',
                interactive: true,
                title: '<img src="styles/legend/AusFacebook_2.png" /> AusFacebook'
            });
var format_Attr_manual_3 = new ol.format.GeoJSON();
var features_Attr_manual_3 = format_Attr_manual_3.readFeatures(json_Attr_manual_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Attr_manual_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Attr_manual_3.addFeatures(features_Attr_manual_3);
var lyr_Attr_manual_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Attr_manual_3, 
                style: style_Attr_manual_3,
                popuplayertitle: 'Attr_manual',
                interactive: true,
                title: '<img src="styles/legend/Attr_manual_3.png" /> Attr_manual'
            });
var format_Viewpoints_4 = new ol.format.GeoJSON();
var features_Viewpoints_4 = format_Viewpoints_4.readFeatures(json_Viewpoints_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Viewpoints_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Viewpoints_4.addFeatures(features_Viewpoints_4);
var lyr_Viewpoints_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Viewpoints_4,
maxResolution:56.00893230452392,
 
                style: style_Viewpoints_4,
                popuplayertitle: 'Viewpoints',
                interactive: true,
                title: '<img src="styles/legend/Viewpoints_4.png" /> Viewpoints'
            });
...
lyr_South_Route_27200_7.set('fieldLabels', {'fid': 'no label', 'name': 'no label', });
lyr_Northland_Route_27200_8.set('fieldLabels', {'fid': 'no label', 'name': 'no label', });
lyr_50kmPunkterueck_9.set('fieldLabels', {'fid': 'no label', 'name': 'no label', 'distance': 'no label', 'angle': 'no label', });
lyr_50kmPunktehin_10.set('fieldLabels', {'fid': 'no label', 'name': 'no label', 'distance': 'no label', 'angle': 'no label', });
lyr_50kmPunkte_South_11.set('fieldLabels', {'fid': 'no label', 'name': 'no label', 'distance': 'no label', 'angle': 'no label', });
lyr_Favorites_12.set('fieldLabels', {'fid': 'no label', 'name': 'no label', 'description': 'no label', 'Titel': 'no label', });
lyr_Favorites_12.on('precompose', function(evt) {
