...
var format_Northland_Rundreise1_6 = new ol.format.GeoJSON();
var features_Northland_Rundreise1_6 = format_Northland_Rundreise1_6.readFeatures(json_Northland_Rundreise1_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Northland_Rundreise1_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Northland_Rundreise1_6.addFeatures(features_Northland_Rundreise1_6);
var lyr_Northland_Rundreise1_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Northland_Rundreise1_6, 
                style: style_Northland_Rundreise1_6,
                popuplayertitle: 'Northland_Rundreise1',
                interactive: true,
                title: '<img src="styles/legend/Northland_Rundreise1_6.png" /> Northland_Rundreise1'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_temp1_1.setVisible(true);lyr_tourism_attraction_2.setVisible(true);lyr_tourism_attraction_3.setVisible(true);lyr_tourism_viewpoint_4.setVisible(true);lyr_Verena_Tspots_5.setVisible(true);lyr_Northland_Rundreise1_6.setVisible(true);lyr_CoromandelNapierneuseeland_2025__route_von_manurewa_auckland_neuseeland_nach_napier_neuseeland_7.setVisible(true);lyr_NapierMtEgmontneuseeland_2025__route_von_napier_neuseeland_nach_cape_egmont_taranaki_neuseeland_8.setVisible(true);lyr_StratfordAucklandneuseeland_2025__route_von_stratford_neuseeland_nach_auckland_airport_kiwi_hotel_9.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_temp1_1,lyr_tourism_attraction_2,lyr_tourism_attraction_3,lyr_tourism_viewpoint_4,lyr_Verena_Tspots_5,lyr_Northland_Rundreise1_6,lyr_CoromandelNapierneuseeland_2025__route_von_manurewa_auckland_neuseeland_nach_napier_neuseeland_7,lyr_NapierMtEgmontneuseeland_2025__route_von_napier_neuseeland_nach_cape_egmont_taranaki_neuseeland_8,lyr_StratfordAucklandneuseeland_2025__route_von_stratford_neuseeland_nach_auckland_airport_kiwi_hotel_9];
...
lyr_Northland_Rundreise1_6.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'Name': 'TextEdit', 'descriptio': '', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMo': '', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', 'fid_2': 'TextEdit', 'id_2': 'TextEdit', 'Name_2': 'TextEdit', 'descript_1': '', 'timestamp_': '', 'begin_2': 'DateTime', 'end_2': 'DateTime', 'altitude_1': '', 'tessella_1': '', 'extrude_2': 'Range', 'visibili_1': '', 'drawOrder_': '', 'icon_2': 'TextEdit', });
